...
// Cálculo de IVA
$base_5 = $base_10 = $base_exenta = $iva_5 = $iva_10 = 0.0;
foreach($detalle as $d) {
    ...
    if($v5 > 0) {
        ...
        $iva_5 = round($base_5 / 21, 2);
    } elseif($v10 > 0) {
        $base_10 += (float)$d['total_parcial'];
        $iva_10 = round($base_10 / 11, 2);
    } else {
        $base_exenta += $vex;
    }
}
    ...
    <table class="factura-table">
        ...
        <?php foreach($detalle as $d): ?>
            <tr>
                ...
                <td><?php echo $d['valor_venta_5'] > 0 ? '5%' : ($d['valor_venta_10'] > 0 ? '10%' : 'Exenta'); ?></td>
                <td><?php echo number_format($d['total_parcial'],0,',','.'); ?></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
            ...
            <tr><td colspan="4" style="text-align:right;"><strong>TOTAL FACTURA:</strong></td><td><strong><?php echo number_format($total_factura,0,',','.'); ?></strong></td></tr>
            <tr><td colspan="5" style="text-align:left;"><strong>Total en letras: </strong><?php echo $total_letras; ?></td></tr>
        </tfoot>
    </table>
